...
scenario_names = ['NPI','NDC','NZ','NDC_CCS1','NZ_CCS1',...
                  ...
                  'NPI_tra','NDC_tra','NZ_tra','NDC_CCS1_tra','NZ_CCS1_tra',...
                  'NPI_pop','NDC_pop','NZ_pop','NDC_CCS1_pop','NZ_CCS1_pop',...
                  'NPI_sc','NDC_sc','NZ_sc','NDC_CCS1_sc','NZ_CCS1_sc',...
                  'NPI_dose','NDC_dose','NZ_dose','NDC_CCS1_dose','NZ_CCS1_dose',...
                  'NPI_dpop','NDC_dpop','NZ_dpop','NDC_CCS1_dpop','NZ_CCS1_dpop']

scenario_source= repmat([NPI_CCS0,NDC_CCS0,NZ_CCS0,NDC_CCS1,NZ_CCS1],1,16);
Scenario_types = repmat(['NPi_CCS0','NDC_CCS0','1.5C_CCS0','NDC_CCS1','1.5C_CCS1'],1,16);
productivity_source = ['C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100',...
                        ...
                        'Transport_3_0','Transport_3_0','Transport_3_0','Transport_3_0','Transport_3_0',...
                        'C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100',...
                        'C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100',...
                        'C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100',...
                        'C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100','C20I5_P100']
...
// SI structural change
S_ind_struct(51:65)=2;
S_ind_struct(66:70)=3;
S_ind_struct(71:75)=4;
S_ind_struct(76:80)=5;


// Load Productivity path calculated with the productivity nexus

// Inputing productivity path
Prod_path = csvRead('../productivity_trajectories/coalregion_SensitivityAnalysis.csv",',','[]',"string");
